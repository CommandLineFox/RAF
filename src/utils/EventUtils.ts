...
export async function generateMail(client: BotClient, message: Message): Promise<void> {
...
export function autoMod(client: BotClient, message: Message, guild: Guild): void {
